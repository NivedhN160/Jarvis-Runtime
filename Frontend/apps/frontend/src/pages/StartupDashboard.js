                ...
                <div className="mt-8 p-6 bg-secondary/20 rounded-xl">
                  ...
                  <Button
                    onClick={() => {
                      ...
                      // Use the dedicated external suggestions endpoint
                      const promise = axios.post(`${API}/ai/external-suggestions`, {
                      ...
                      toast.promise(promise, {
                        loading: 'Searching global creator database...',
                        success: (res) => {
                          // Display the suggestions returned by the endpoint
                          return `AI Suggestions: ${res.data.suggestions ? res.data.suggestions.substring(0, 150) : 'Check console'}...`;
                        },
